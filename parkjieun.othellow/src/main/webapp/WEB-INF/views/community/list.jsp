						...
						$(".move")
								.on(
										...
										function(e) {
											e.preventDefault();
											actionForm
													.append("<input type='hidden' name='seq' value='"
															+ $(this).attr(
																	"href")
															+ "'>");
...
<body>
	...
	<div class="table-header">
		...
		<form name="sort" class="sort">
			<div class="sort-group">
				<span class='sortList' id='list' onclick="location.href='list';">전체</span>
				| <span class='sortList' id='informList'
					onclick="location.href='inform';">공지</span> | <span
					class='sortList' id='chatList' onclick="location.href='chat';">잡담</span>
	...
	<table class="table-wrapper">
		...
		<tbody id='communityList' name='communityList'>
			<c:forEach items="${communityList }" var="community">
				<tr class="listToChange" style="cursor: pointer;"
					onClick="location.href='<c:out  value="viewPost/${community.seq }"/>'">
					<%-- <tr style="cursor: pointer;" class='move' onClick="location.href='/community/viewPost?seq=<c:out value="${community.seq }"/>'"> --%>
					<td class="scrolling" data-seq="${community.seq}">
	...
	<div class="content-footer">
		<div class="write-button"
			...
			onclick="location.href='insertPost'">글쓰기</div>
		...
		<div class="search-wrapper">
			<select class="searchType" name="searchType" id="searchType">
				...
				placeholder="검색어를 입력하세요" /> <span class="search-button"
				name="search-button" id="search-button" onclick="fn_searchList();">SEARCH</span>
		</div>
	</div>
</body>
<style>
